...
---
## The Tech
This project was a single page app in Angular 2, SASS/CSS3, HTML5, Bootstrap, Google Maps front end, and .Net Core Web API back end using AWS SNS (Simple Notification Service) for text messaging between the service technician and the customer. This web app was hosted on AWS EC2.
